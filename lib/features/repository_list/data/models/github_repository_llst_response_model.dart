class GitHubRepositoryListResponseModel {
  GitHubRepositoryListResponseModel({
    required this.totalCount,
    required this.incompleteResults,
    required this.gitHubRepositoryList,
  });
  late final int totalCount;
  late final bool incompleteResults;
  late final List<GitHubRepository> gitHubRepositoryList;

  GitHubRepositoryListResponseModel.fromJson(Map<String, dynamic> json){
    totalCount = json['total_count'];
    incompleteResults = json['incomplete_results'];
    gitHubRepositoryList = List.from(json['items']).map((e)=>GitHubRepository.fromJson(e)).toList();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['items'] = gitHubRepositoryList.map((e)=>e.toJson()).toList();
    return _data;
  }
}
...
class Permissions {
  ...
  late final bool maintain;
  late final bool push;
  late final bool triage;
